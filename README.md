...
## Project Setup
The framework `MBLibrary` referenced by this project is available [here](https://github.com/piscoTech/MBLibrary), version currently in use is [1.7](https://github.com/piscoTech/MBLibrary/releases/tag/v1.7(18)).
